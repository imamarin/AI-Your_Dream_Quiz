...
def build_prompt(subject: str, level: str, aspiration: str, n: int = 5, materi: str) -> str:
    return f"""
...
def generate_questions(api_key: str, subject: str, level: str, aspiration: str, n: int=5, materi: str):
    prompt = build_prompt(subject, level, aspiration, n, materi)
