...
1. 3 soal multiple_choice (pilihan ganda, 4 opsi A-D).
2. 1 soal matching (mencocokkan, ada daftar kiri dan kanan yang harus dipasangkan).
3. 1 soal ordering (mengurutkan item dalam urutan benar)
