...
Persyaratan:
- Minimal 1 dari {n} soal bertipe "image" (menggunakan gambar kontekstual). cari dulu gambarnya baru deskripsikan soalnya Jika sulit, boleh gunakan ilustrasi/infografik yang tersedia online.
