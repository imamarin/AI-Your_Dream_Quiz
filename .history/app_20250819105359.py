...
- Untuk soal bertipe "image", sertakan field "image_url" yang MERUJUK ke gambar publik (mis. situs pendidikan, atau domain bebas pakai). Pastikan URL langsung ke file gambar (jpg/png/webp) jika memungkinkan.
